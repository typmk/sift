(ns com.typemark.sift.pattern
  "Structural matching over forms with metavariables — the vocabulary
  defnet's `edit op=pattern` already speaks, portable, plus repetition.
